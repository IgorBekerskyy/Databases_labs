...
public class MainView {
    ...
    private final BonusAccountController bonusAccountController = new BonusAccountController();
    ...
    private final PackagingController packagingController = new PackagingController();
    private final SalonController salonController = new SalonController();
